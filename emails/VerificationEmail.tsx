...
export default function VerificationEmail({ username, otp }: VerificationEmailProps) {
  return (
    <Html lang="en" dir="ltr">
      <Head>
        <title>HireJobs - OTP Verification</title>
        <Font
          fontFamily="Roboto"
      ...
      <Preview>Verify your HireJobs account with the OTP: {otp}</Preview>
      <Section style={{ padding: '20px', backgroundColor: '#f4f4f4' }}>
        ...
        <Row>
          <Text style={{ fontSize: '16px', color: '#555' }}>
            Thank you for signing up for HireJobs. To complete your registration, please use the verification code below:
          </Text>
        </Row>
